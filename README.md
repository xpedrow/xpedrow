...
Estudante de **Ciência da Computação** focado na intersecção entre engenharia de software robusta e designs altamente sofisticados e interativos. Minha abordagem combina o desenvolvimento de ecossistemas digitais de alta performance para o mercado corporativo com a criação de interfaces modernas, fluidas e focadas na experiência do usuário.
